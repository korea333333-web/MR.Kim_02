        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
          ...
          <div className="md:col-span-2 glass-card rounded-2xl p-8 hover-lift">
            <p className="text-lg text-[#d4c4b0] leading-relaxed mb-6">
              사진, 사운드, 영상 콘텐츠를 기획하고 제작해온 경험을 바탕으로,
              지금은 AI 기반 프로그램 개발과 기업 AX 전환 교육으로 활동 영역을
              확장하고 있습니다. 콘텐츠 제작 역량에 기술을 더해, 실제 업무에
              사용할 수 있는 자동화 도구와 실무형 교육을 만듭니다.
            </p>
            <p className="text-lg text-[#d4c4b0] leading-relaxed">
              현재는 생성형 AI를 활용한 이미지·영상·음악 제작은 물론, 기업의
              업무 효율을 높이는 웹 프로그램과 AI 워크플로우를 설계하고 있습니다.
              단순히 콘텐츠를 만드는 것을 넘어,{" "}
              <span className="text-[#c9a66b] font-medium">
                AI를 조직과 개인의 실무 생산성으로 연결하는 일
              </span>{" "}
...
function AwardsSection() {
  ...
  const projects = [
    ...
    },
    {
      ...
      image: null,
      videoUrl: "https://www.youtube.com/watch?v=nJWjH9SkJcA",
      embedUrl: "https://www.youtube.com/embed/nJWjH9SkJcA",
